  ...
  return (
    <article className="flex flex-col rounded-2xl border border-white/7 bg-slate-950/55 p-4 transition hover:border-violet-300/20">
      <div className="flex items-center gap-3">
        ...
        {member.isMega ? <Badge variant="outline" className="shrink-0 self-start border-fuchsia-300/25 bg-fuchsia-300/10 px-2 text-[9px] font-black text-fuchsia-100">Mega</Badge> : null}
      </div>
      <div className="mt-3">
